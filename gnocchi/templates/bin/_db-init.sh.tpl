...
#pgsql_superuser_cmd "GRANT SELECT, UPDATE, INSERT, DELETE ON ALL TABLES IN SCHEMA public TO $DB_USER;" $DB_NAME

#pgsql_superuser_cmd "GRANT ALL ON SCHEMA public TO $DB_USER;"

#pgsql_superuser_cmd "GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO $DB_USER;"
